                                    ...
                                    @foreach($dataType->browseRows as $row)
                                        <td>
                                            ...
                                            @elseif($row->type == 'select_dropdown')
                                                    ...
                                                    <?php $relationshipOptions = $relationshipClass::find($data->{$row->field}); ?>
                                                    <?php $relationDataType = \TCG\Voyager\Models\DataType::where('model_name',$relationshipClass)->first()?>
                                                    <a href="{{ route('voyager.'.$relationDataType->slug.'.show', $data->{$row->field}) }}" >{{ $relationshipOptions?$relationshipOptions->name:null }}</a>
                                            @else
                                                {{ $data->{$row->field} }}
                                            @endif
                                        </td>
